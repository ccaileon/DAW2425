...
<body>
  ...
  <main class="flex-grow-1">
    ...
    <div class="container mt-5 mb-5">
      ...
      //Versión segura:
      /*
      $stmt = $database->prepare("SELECT * FROM usuarios WHERE nombre = ?");
      $stmt->bind_param("s", $nombre); // "s" porque nombre es string
      $stmt->execute();
      $resultado = $stmt->get_result(); // Si quieres fetch_all:
