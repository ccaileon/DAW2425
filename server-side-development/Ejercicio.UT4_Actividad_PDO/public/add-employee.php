...
if ($_SERVER["REQUEST_METHOD"] === 'POST') {
  if (
    isset($_POST['nombre'], $_POST['apellido'], $_POST['email'], $_POST['salario']) &&
    ...
    try {
      ...
      $mensaje = 'Error al añadir el empleado: ' . $e->getMessage();
    }
  }
}
?>
...
<body>
  <header>
    <ul class="nav justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="add-employee.php">Añadir</a>
      </li>
      <li class="nav-item">
  ...
  <?php
  if ($mensaje === "Empleado añadido con éxito") {
    echo '<script>
            Swal.fire({
                title: "' . $mensaje . '",
                icon: "success",
